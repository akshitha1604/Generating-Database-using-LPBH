...
while True:
	...
	if face_detector(capturing) is not None:
		...
		path = 'C:\\Users\\akshitha\\OneDrive\\Desktop\\attendance_management_system_using_face_recognition\\ATTENDANCE  MANAGEMENT SYSTEM\\human_faces\\' + str(face_count) + '.jpg'
