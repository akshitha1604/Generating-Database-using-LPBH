...
path = 'C:\\Users\\akshitha\\OneDrive\\Desktop\\attendance_management_system_using_face_recognition\\ATTENDANCE  MANAGEMENT SYSTEM\\human_faces\\'
...
face_detect = cv2.CascadeClassifier('C:\\Users\\akshitha\\OneDrive\\Desktop\\attendance_management_system_using_face_recognition\\ATTENDANCE  MANAGEMENT SYSTEM\\haarcascade_frontalface_default.xml')
...
while True:
	...
	try:
		...
		if score > 70:
			...
			cv2.putText(image, "Welcome Akshitha", (210, 40), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,255), 2)
			
			# Display Real-time Face Recognition using imshow built-in function
			cv2.imshow('Real-time Face Recognition', image)
		
		else:
			cv2.putText(image, "This is NOT Akshitha", (150, 100), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 3)
			cv2.imshow('Real-time Face Recognition', image)
...
cv2.destroy('Real-time Face Recognition')
